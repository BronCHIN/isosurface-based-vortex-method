function [ geom, iner, cpmo ] = subourtine_polygeom( x, y ) 
...
%---by Bron 07/23 2018  仅仅计算一二象限的角度，且必须I2>I1
ang1=ang1*180/pi;
ang2=ang2*180/pi;
if ang1<0
    ang1=ang1+180;
